...
type PluginCreateFunc func(cfg table.WeightedEntityMeta, env config.EnvConfig) IStrategyEntity
...
func PluginFactoryCreate(cfg table.WeightedEntityMeta, envCfg config.EnvConfig) IStrategyEntity {
