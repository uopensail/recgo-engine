...
type PluginCreateFunc func(cfg table.ScatterEntityMeta, env config.EnvConfig) IStrategyEntity
...
func PluginFactoryCreate(cfg table.ScatterEntityMeta, envCfg config.EnvConfig) IStrategyEntity {
