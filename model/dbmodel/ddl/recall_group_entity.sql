...
CREATE TABLE IF NOT EXISTS `recall_group_entity` (
  ...
  `recall_entities` JSON NOT NULL COMMENT 'json int array recall_entity.id ',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='匹配召回组计算实体'